...
{
    public class TaskProcessContext : DbContext
    {
        // public ILogger _logger { get; }
        private readonly IConfiguration _env;
        public DbSet<TaskProcessItem> TaskProcessItems { get; set; }

        public TaskProcessContext(DbContextOptions<TaskProcessContext> options, IConfiguration env)
            : base(options)
        {
            // _logger = logger;
            _env = env;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TaskProcessItem>(entity =>
            {
